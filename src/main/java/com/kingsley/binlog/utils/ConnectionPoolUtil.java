package com.kingsley.binlog.utils;
...
public class ConnectionPoolUtil {
    ...
    private Connection findFreeConnection() throws SQLException {
        ...
        log.info("--------------:获得一个可用的数据库连接（findFreeConnection）");
